...
public enum ErrorCode {
	...
	IS_kjuns_NOT_EXIST("200008","不是练习生"),
	USER_INFO_NOT_EXIST("200009","用户信息不存在"),
	USER_SIGN_IN_EXIST("200010","用户已签到"),
	...
	TYPE_CODE_NOT_EXIST("400000","不存在子类别"),
	
	//业务处理
	DEAL_MIN_AMOUNT("600000","豆子数必须大于1个"),
	DEAL_USER_SAME("600001","不能给自己喂豆"),
	DEAL_AMOUNT_NOT_ENOUGH("600002","豆子不足"),
	NOT_FOLLOW("600003","不能关注自己"),
	IS_FOCUS("600004","已关注该用户"),
	RECOMMEND_kjuns_LENTH("600005","推荐练习生已达上限"),
	
	//动态
	DYNAMIC_TYPE_ERROR("700000","发布信息请选择类别"),
	DYNAMIC_NOT_SLEF("700001","不能删除别人动态"),
	DYNAMIC_DEL("700002","动态已被删除"),
	
	//交易
	PAY_ERROR("800000", "服务端错误无法进行预下单"),
	PAY_INVALID_ORDER("800001", "无效订单"),
	PAY_WX_ENABLE("800002","微信支付关闭中"),
