...
<head>
	...
	<script type="text/javascript"> 
		...
		function gotoPage(pageNumber) {
			...
			var name = $('#name').val();
			location.href = "${basePath}/content/tag/list?pageNumber=" + pageNumber+"&name="+name;
		}
		...
		function confirm(){
			...
			parent.closeTags(chk_value.toString(), chk_name.toString());
		}
...
<body>
	...
	<div class="rightinfo">
		<form action="content/tag/list" id="myForm">
		...
		<table class="tablelist">
			...
			<tbody>
				<c:forEach items="${page.list}" var="tag">
					<tr>
						<th>
							<input type="checkbox" name="checkbox" value="${tag.id}"/>
							<input type="hidden" id="${tag.id}" value="${tag.name}"/>
						</th>
						<td>${tag.name}</td>
